    ...
    class Program
    {
        class MainClass
        {
            ...
            static void Main(string[] args)
            {
                ...
                Func<int, bool> ConditionMore = GreaterThanFive;
                ...
                Func<int, bool> Condition3kplus1 = new Func<int, bool>(delegate (int x) { return x % 3 == 1; }); 
            ...
            public static bool GreaterThanFive(int x) { return x > 5; }
            public static bool LessThanFive(int x) { return x < 5; }
