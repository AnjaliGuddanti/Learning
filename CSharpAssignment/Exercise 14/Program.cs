...
{
    public class Product : IEquatable<int>
    {
        private int id;
        private float price;
        ...
        public int Id //concept of properties
        {
            get { return id; }
            set { id = value; }
        }
        ...
        public float Price //concept of properties
        {
            get { return price; }
            set { price = value; }
        }
    ...
    public class Program14
    {
        public static void Main()
        {
            ...
            Dictionary<Product, int> products = new Dictionary<Product, int>(); //creating a dictionary named products
