...
namespace WebApplicationAPI.Controllers
{
    ...
    public class ShowTimesController : ControllerBase
    {
        ...
        [HttpGet("{movieName}")]
        public async Task<ActionResult<IEnumerable<ShowTime>>> GetShowTimeByMovieName(string movieName)
        {
            var showTime = await _context.ShowTimes.Where(x => x.MovieName.ToLower() == movieName.ToLower()).OrderBy(x => x.Id).ToListAsync(); ;
